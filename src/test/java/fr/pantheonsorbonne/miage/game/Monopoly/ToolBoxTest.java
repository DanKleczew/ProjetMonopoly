...
public class ToolBoxTest {
    @Test
    public static void mapToPerfectBoard(/*  Map<String, String> map*/) throws IsBankruptException {
       PerfectBoard BoardTest = new PerfectBoard();
    ...
    public static Map<String, String> perfectBoardToMap(PerfectBoard board, Player player) {
        ...
        for (CaseAchetable proprieteParticuliere : listeDesProp) {
            ...
            if (proprieteParticuliere.getOwner().equals(player)) {
                builder.append("1;");
            } else {
                builder.append("2;");
            }
            if (proprieteParticuliere instanceof CasePropriete) {
                ...
                if (propriete.isAJail()) {
                    builder.append("6");
                        ...
                        || proprieteParticuliere instanceof CaseCompagnie) {
                    builder.append("7");
                } else {
